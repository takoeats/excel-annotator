...
import com.junho.excel.testdto.LargeDataDTO;
import com.junho.excel.util.ExcelAssertions;
...
class Style64KLimitTest {
    ...
    void applicationLevelCache_singletonStyleInstances() {
        com.junho.excel.style.CustomExcelCellStyle instance1 =
            com.junho.excel.style.StyleCache.getStyleInstance(
                com.junho.excel.example.style.CurrencyStyle.class);

        com.junho.excel.style.CustomExcelCellStyle instance2 =
            com.junho.excel.style.StyleCache.getStyleInstance(
                com.junho.excel.example.style.CurrencyStyle.class);
